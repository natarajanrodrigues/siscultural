...
//        public static final Comparator<Contract> PRESENTATION_DATE = (Contract c1, Contract bc2) ->
//        {
//            Contract c1 = c1;
//
//            if (true){
//
//                return c1.getAccomplishments().get(0).getDateTime().compareTo(bc2.getAccomplishments().get(0).getDateTime());
//            }
//            return 0;
//        }
//        );
