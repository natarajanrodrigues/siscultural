...
public class LocalityRepositoryIT {
    ...
    @Test
    public void testeFindLocalityById() {

        Assert.assertNotNull(repo.findById(Long.parseLong("1")));
        
    }

//    @Test
//    public void testeRemoveLocality() {
//
//        repo.delete(repo.findById(Long.parseLong("1")));
